...
import 'package:taxiui/rideaccept.dart';

class offerfare extends StatefulWidget {
  const offerfare({Key? key}) : super(key: key);

  @override
  _offerfareState createState() => _offerfareState();
}

class _offerfareState extends State<offerfare> {
  @override
